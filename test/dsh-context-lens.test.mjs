...
test('tracked package sources contain no host-specific infra references', () => {
  const tracked = ['README.md', 'package.json', 'cordis.patch.yml', 'lib/client.js', 'lib/index.js'];
...
test('browser entry does not depend on removed dsh-client-runtime (alpha2)', () => {
  ...
  assert.equal(inject.includes('@deepseek-ai/dsh-client-ui-slots'), true, 'inject must contain dsh-client-ui-slots — инвертировано для ядра 0.1.2-rc.1 (модуль убран)');
