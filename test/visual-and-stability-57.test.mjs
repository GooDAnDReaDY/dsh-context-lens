...
test('client.js binds configForms reactively without foreign lanSettings (#64)', () => {
  assert.ok(clientSrc.includes("configForms"), 'client.js must bind configForms reactively');
